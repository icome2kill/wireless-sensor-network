...
EXECUTE_ON_STARTUP(
    ...
    e->insert(APP_SEND_TEMPERATURE_DATA_HIGH, "APP_SEND_TEMPERATURE_DATA_HIGH");
    e->insert(APP_SEND_TEMPERATURE_DATA_LOW, "APP_SEND_TEMPERATURE_DATA_LOW");
    ...
    e->insert(APP_SEND_DATA_REAL, "APP_SEND_DATA_REAL");
);
...
EXECUTE_ON_STARTUP(
    ...
    e->insert(RDC_SWITCH_FREQ_CHANNEL, "RDC_SWITCH_FREQ_CHANNEL");
);
...
EXECUTE_ON_STARTUP(
    ...
    e->insert(PHY_SWITCH_FREQ_CHANNEL, "PHY_SWITCH_FREQ_CHANNEL");
);
